    ...
    <section id="parish-life" className="py-20 sm:py-28 bg-gradient-to-b from-navy-800 to-navy-900 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-6 lg:p-8">
            ...
            <div className="mt-5 space-y-4">
              ...
              <StaffMember role="Deacons" name="David Farris, Kevin Henderson" />
              <StaffMember role="Parish Secretary" name="Jonine Blackshear" />
        ...
        <div className="mt-14 flex flex-wrap items-center justify-center gap-3">
          ...
          <QuickLink href="http://www.usccb.org/bible/books-of-the-bible/index.cfm" label="Bible Online (NAB)" />
